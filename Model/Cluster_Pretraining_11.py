...
train_functions = {
    ...
    "train_model_imubi": lambda: __import__("Pretraining_JLR_imubi_11").train_model_imubi(epochs=300, batch_size=batch_size, h5_file_path=h5_file_path),
    "train_model_imubi_ft": lambda: __import__("Pretraining_JLR_imubi_ft_11").train_model_imubi_ft(epochs=300, batch_size=batch_size, h5_file_path=h5_file_path),
}
