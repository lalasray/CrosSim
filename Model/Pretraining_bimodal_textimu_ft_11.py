...
# Training Function
def train_bimodel_ft(epochs=300, batch_size=512, learning_rate=0.001, early_stop_patience=20, patience=15, patience_factor=0.5, h5_file_path = "../CrosSim_Data/UniMocap/full_dataset.h5"):
    log_file = open("training_log_textimu_ft_11.txt", "w")
    ...
    torch.save(model.state_dict(), "textimu_ft_11.pth")
