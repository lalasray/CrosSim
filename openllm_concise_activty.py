...
client = OpenAI(model="gpt-4o-mini", temperature=0, api_key="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")

import openai

# Initialize OpenAI client
openai.api_key = "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"
...
def load_class_list(file_path="class_list.json"):
    ...
    if os.path.exists(file_path):
        ...
        initial_classes = ["running", "walking", "acting", "jumping", "eating"]
        with open(file_path, 'w') as file:
